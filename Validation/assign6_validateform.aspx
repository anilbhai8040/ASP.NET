...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" 
        ...
        ErrorMessage="Name must be in Alphabets !!!" Display="Dynamic" 
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator5" 
        ...
        ErrorMessage="Age must be number !!!" ValidationExpression="^[0-9]+$"></asp:RegularExpressionValidator>
    <br />
    <br />
...
&nbsp;&nbsp;
    ...
    <asp:CustomValidator ID="CustomValidator3" runat="server" Display="Dynamic" 
        ErrorMessage="Education Must Be Selected !!!" 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ...
        ErrorMessage="Confirm Password Does Not Match !!!"></asp:CompareValidator>
    <br />
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:RangeValidator ID="RangeValidator1" runat="server" 
        ControlToValidate="TextBox8" Display="Dynamic" 
        ErrorMessage="Mobile Number Must Be Valid !!!" MaximumValue="9999999999" 
        MinimumValue="1000000000"></asp:RangeValidator>
    <br />
    <br />
    <asp:CheckBox ID="CheckBox4" runat="server" Text="I Agree" />
    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" 
        ErrorMessage="Agree Turm And Condition !!!" 
    ...
    <br />
    <br />
    <asp:Label ID="Label11" runat="server" ForeColor="#00CC00"></asp:Label>
</form>
</body>
</html>
